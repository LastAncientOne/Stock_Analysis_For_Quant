...
<img src="https://latex.codecogs.com/svg.image?Entropy(T,&space;X)&space;=&space;\sum_{v\in&space;&space;Values(A)}^{}\frac{\left|&space;S_{v}\right|}{\left|S&space;\right|}Entropy(S_{v})" title="Entropy(T, X) = \sum_{v\in Values(A)}^{}\frac{\left| S_{v}\right|}{\left|S \right|}Entropy(S_{v})" width="400" height="100">
