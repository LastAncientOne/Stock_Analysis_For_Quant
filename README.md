...
### Description:  
#### This is a Stock Analysis project in Excel, Tableau, Power BI, Matlab, Python, R, and Tableau language, involving various types of analysis such as data analysis, technical analysis, fundamental analysis, quantitative analysis, candlestick patterns, and different types of trading strategies. The project covers stocks, options, bonds, mutual funds, and ETFs (Exchange-traded funds). Additionally, it focuses on quantitative research and analysis in trading and investment. Quantitative analysis (QA) is a technique that utilizes mathematics, statistical modeling, measurement, and research to understand financial behaviors. The project includes many different types of technical indicators and stock strategies in Excel, Tableau, Power BI, Matlab, Python, and R languages. Time series analysis, forecasting, machine learning, and deep learning are used for this research project across various programming languages. :chart_with_upwards_trend: :chart_with_downwards_trend:  

### What is stock market?  
#### The stock market, or equity market, is primarily known for trading stocks or equities, as well as other financial securities such as exchange-traded funds (ETFs), corporate bonds, and derivatives based on stocks, commodities, currencies, and bonds.  

### What is U.S. stock and non U.S. stock?  
#### U.S. equities refer to companies that trade on the U.S. stock exchange, while non-U.S. equities are those whose shares are cross-listed on a U.S. exchange. Consequently, many international companies choose to have their stocks traded on a U.S. stock exchange. For instance, when a foreign company decides to list its stock on a U.S. exchange, it must determine whether to be classified as a "foreign private issuer" under U.S. securities laws. However, foreign private issuers are subject to distinct reporting and regulatory obligations compared to U.S. companies.  
